...
--
-- Host: localhost:3306
-- Generation Time: Feb 18, 2022 at 11:20 PM
...
--
-- Dumping data for table `savedacc`
--

INSERT INTO `savedacc` (`AccountsID`, `UserID`, `Websitename`, `Usernameacc`, `Emailacc`, `Passwordacc`) VALUES
(1, 1, 'Facebook', 'AymanSd', 'Sedqi123@outlook.fr', '123456789'),
(2, 1, 'Facebook', 'AymanSd', 'sedqi123@outlook.fr', '123456789'),
(3, 1, 'Youtube', 'AymanSd', 'aymansd2002@gmail.com', '202020202020');
...
(1, 'AymanSd', 'sedqi123@outlook.fr', '$2y$10$b1Sjx9gvFi/3jIqw/5lR6ugSJC.URQI5KU577sH5wxGHqB9v9zzNq', 'Ayman Sedqi', 0),
(2, 'Gambullii', 'aymansd2002@gmail.com', '$2y$10$fdLyE5P7ekUzytSK80ozHeoOT7voPXtBH.k2sffwYuOhh.wFd43yy', 'Gambullii', 2525);
...
--
ALTER TABLE `savedacc`
  MODIFY `AccountsID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Saved accounts Id', AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `users`
--
ALTER TABLE `users`
  MODIFY `UserID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Users Accounts Id', AUTO_INCREMENT=3;
